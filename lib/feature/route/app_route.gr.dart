...
import 'package:vm_fm_4/product/wrapper/app_wrapper.dart' as _i11;
...
class DetailWorkOrderScreen
  ...
  DetailWorkOrderScreen({
    _i13.Key? key,
    required _i14.WorkSpaceDetail workSpaceDetail,
...
class DetailWorkOrderScreenArgs {
  ...
  final _i14.WorkSpaceDetail workSpaceDetail;
...
class MyWorkOrders extends _i12.PageRouteInfo<MyWorkOrdersArgs> {
  MyWorkOrders({
    _i13.Key? key,
    required _i15.WorkOrderListProvider provider,
    List<_i12.PageRouteInfo>? children,
  }) : super(
          MyWorkOrders.name,
...
class MyWorkOrdersArgs {
  ...
  final _i15.WorkOrderListProvider provider;
