...
part 'generator_work_order_support_model/component_image_model.g.dart';
...
class ComponentImageModel extends Equatable {
  ...
  factory ComponentImageModel.fromJson(Map<String, dynamic> json) =>
      _$ComponentImageModelFromJson(json);
