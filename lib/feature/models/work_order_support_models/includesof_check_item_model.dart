...
part 'generator_work_order_support_model/includesof_check_item_model.g.dart';
...
class IncludesOfCheckItemModel extends Equatable {
  ...
  factory IncludesOfCheckItemModel.fromJson(Map<String, dynamic> json) =>
      _$IncludesOfCheckItemModelFromJson(json);
