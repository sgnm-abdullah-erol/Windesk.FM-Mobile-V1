...
part 'generator_work_order_support_model/component_original_model.g.dart';
...
class ComponentOriginalModel extends Equatable {
  ...
  factory ComponentOriginalModel.fromJson(Map<String, dynamic> json) =>
      _$ComponentOriginalModelFromJson(json);
