...
part 'generator_work_order_support_model/start_check_list_value_model.g.dart';
...
class StartCheckListValueModel extends Equatable {
  ...
  factory StartCheckListValueModel.fromJson(Map<String, dynamic> json) =>
      _$StartCheckListValueModelFromJson(json);
