...
part 'generator_work_order_support_model/checklist_has_regulation_model.g.dart';
...
class CheckListHasRegulationModel extends Equatable {
  ...
  factory CheckListHasRegulationModel.fromJson(Map<String, dynamic> json) =>
      _$CheckListHasRegulationModelFromJson(json);
  ...
  static List<CheckListHasRegulationModel> fromJsonList(List<dynamic> json) {
    ...
    for (var item in json) {
      checkListHasRegulationModel
          .add(CheckListHasRegulationModel.fromJson(item));
    }
