...
part 'generator_work_order_scope_model/start_check_list_value_class_model.g.dart';
...
class StartCheckListValueClassModel extends Equatable {
  ...
  factory StartCheckListValueClassModel.fromJson(Map<String, dynamic> json) => _$StartCheckListValueClassModelFromJson(json);
  ...
  static List<StartCheckListValueClassModel> fromJsonList(List<dynamic> json) {
    ...
    for (var item in json) {
      startCheckListValueClassModel.add(StartCheckListValueClassModel.fromJson(item));
    }
