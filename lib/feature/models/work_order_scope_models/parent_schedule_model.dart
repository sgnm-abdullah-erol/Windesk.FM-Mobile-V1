...
part 'generator_work_order_scope_model/parent_schedule_model.g.dart';
...
class ParentScheduleModel extends Equatable {
  ...
  factory ParentScheduleModel.fromJson(Map<String, dynamic> json) => _$ParentScheduleModelFromJson(json);
