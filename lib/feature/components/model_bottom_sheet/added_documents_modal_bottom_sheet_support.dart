...
class AddedDocumentsModalBottomSheetSupport extends StatelessWidget {
  const AddedDocumentsModalBottomSheetSupport(
        ...
        builder: GraphqlResultHandling.withGenericHandling(
          ...
          (QueryResult result, {refetch, fetchMore}) {
            ...
            final resultDataQuery = result
                .data?['supports'].first['CheckListValue'].first['Document'];
            return SizedBox(
              ...
              child: Padding(
                ...
                child: ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      bool containPdf = resultDataQuery?[index]['url']
                              .toString()
                              .contains('.pdf') ??
                          false;
                      return ListTile(
                            ...
                            return Row(
                              ...
                              children: [
                                Flexible(
                                    flex: 1,
                                    child: Text(
                                        resultDataQuery?[index]['name'] ?? '')),
                                Flexible(
                                  flex: 1,
                                  child: TextButton.icon(
                                    onPressed: openLink,
                                    label: containPdf
                                        ? const Text('Dökümana Git')
                                        : const Text('Fotoğrafa Git'),
