        ...
        children: [
          ...
          Expanded(
            child: DropDownInputFields(
                labelText: AppStrings.durum, onChangedFunction: selectStateFunction, rightIcon: AppIcons.arrowDown, dropDownArray: stateList),
          ),
          Expanded(
            child: DropDownInputFields(
                labelText: AppStrings.bina, onChangedFunction: selectBuildFunction, rightIcon: AppIcons.arrowDown, dropDownArray: buildList),
          ),
          Expanded(
            child: DropDownInputFields(
                labelText: AppStrings.kat, onChangedFunction: selectFloorFunction, rightIcon: AppIcons.arrowDown, dropDownArray: floorList),
          ),
          Expanded(
            child: DropDownInputFields(
                labelText: AppStrings.kanat, onChangedFunction: selectWingFunction, rightIcon: AppIcons.arrowDown, dropDownArray: wingList),
          ),
        ],
      ),
    );
