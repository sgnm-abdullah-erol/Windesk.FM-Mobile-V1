              ...
              children: [
                ...
                AutoRoute(
                    ...
                    page: ScopeDetail.page),
                     AutoRoute(
                    path: 'supportList',
                    page: SupportList.page),
                AutoRoute(
                    path: 'supportDetail',
                    page: SupportDetail.page),
              ],
            ),
            AutoRoute(
              ...
              children: [
                ...
                AutoRoute(
                    ...
                    initial: true),
                AutoRoute(
                    path: 'assetSearchScreen', page: AssetSearchScreen.page),
                AutoRoute(
                    path: 'spaceSearchScreen', page: SpaceSearchScreen.page),
                AutoRoute(
                    path: 'assetDetailScreen', page: AssetDetailScreen.page),
              ],
            ),
            AutoRoute(
                path: 'emptyNewOrderScreen',
                page: EmptyRouter3.page,
                children: [
